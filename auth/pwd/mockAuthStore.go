...
import "github.com/elga-io/short/auth/jwt"
...
type MockAuthStore struct {
	...
	AuthAccountFn      func(email, password string) (*Account, error)
	AuthAccountInvoked bool
}
...
func (s *MockAuthStore) AuthAccount(e, p string) (*Account, error) {
	s.AuthAccountInvoked = true
	return s.AuthAccountFn(e, p)
}